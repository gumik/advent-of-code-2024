...
tests = TestLabel "InputTest" $ test
    ...
    , inputTest Day06.solution (4559, 1604)
    , inputTest Day07.solution (7710205485870, 20928985450275)
    , inputTest Day08.solution (244, 912)
    , inputTest Day09.solution (6154342787400, 6183632723350)
    , inputTest Day10.solution (698, 1436)
    , inputTest Day11.solution (189167, 225253278506288)
    , inputTest Day12.solution (1396298, 853588)
    , inputTest Day13.solution (31065, 93866170395343)
    , inputTest Day14.solution (209409792, NoSolution)
    , inputTest Day15.solution (1412971, 1429299)
    , inputTest Day16.solution (NoSolution, NoSolution)
    , inputTest Day17.solution ("3,6,3,7,0,7,0,3,0", NoSolution)
